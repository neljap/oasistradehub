...
import { MktStockData } from '../../../../utils/AppData'

const StockTdChart = () => {
    const {coin, obj} = useParams()
  
  let singledata = MktStockData.find((item) => item.stock == coin)
    ...
    return(
     <div>
          ...
          <BuyMarketCard coin={coin} butClass="bg-green-700" butext="Buy" img={singledata?.img}/>
          <BuyMarketCard coin={coin} butClass="bg-red-700" butext="Sell" img={singledata?.img}/>
          </div>  
          <div className="pb-4">
