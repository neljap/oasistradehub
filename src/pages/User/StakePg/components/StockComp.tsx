...
const StockComp = () => {
  const [stakeOpen, setStakeOpen] = useState(false);
    ...
    const {inputStkStock, handleStkStock, filteredStkStock} = useContext(StakeContext);

  return (
    <div> 
      <div className="my-4">
        <input type="text" value={inputStkStock} onChange={handleStkStock} placeholder="Search Cryptos eg. 'BTC'" className="w-full border border-neutral-200 rounded-xl p-2"/>
      </div>
