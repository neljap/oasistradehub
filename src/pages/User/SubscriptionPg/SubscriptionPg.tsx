    ...
    <div>
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-8">
          ...
          <div className={`w-full rounded-lg dark:bg-[#2a3042] border ${item.id == 1 ? "border-purple-400" : item.id == 2 ? "border-primary" : item.id == 3 ? "border-red-400" : "border-yellow-400"} p-8 flex flex-col justify-between font-[Jost]`} key={item.id}>
